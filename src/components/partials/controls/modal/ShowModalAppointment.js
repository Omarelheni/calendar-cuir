...
const ShowModalAppointment = ({ children, size = "md", isLoading, print = true, printURL, title, onHide,onCancel, show, dialogClassName }) => {
...
export default ShowModalAppointment
