...
const TableOfItems = ({ field, object, history }) => {
  ...
  const { name, columns, showSearch = false, openShowPage,showPagToolbar=true, openValidateJobDialog, addAnotherActions, showActions = true, icon, label, size = 12 } = field
